...
class AdminResultControllerTest {
    private static final String BASE_URL = "/admin/results/";
    ...
    void update() throws Exception {
        ...
        persistSample(persistentEntity);
        ResultDto updatedDto = resultMapper.toDto(persistentEntity)
                .setName("newName");
        ResultDto invalidUpdatedDto = resultMapper.toDto(persistentEntity)
                .setName("");
        mockMvc.perform(
